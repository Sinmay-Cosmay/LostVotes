	...
	<div class="col-lg-12">
		<div class="row">
			<div class="card col-lg-12">
				...
				<!-- <a href="main.php?page=files" class="">..</a>/ -->
				<?php 
				$id=$folder_parent;
				while($id > 0){
					...
					echo '<script>
						$("#paths").prepend("<a href=\"main.php?page=files&fid='.$path['id'].'\">'.$path['name'].'</a>/")
					</script>';
					$id = $path['parent_id'];

				}
				echo '<script>
						$("#paths").prepend("<a href=\"main.php?page=files\">..</a>/")
					</script>';
				?>
...
<script>
	...
	$('.folder-item').dblclick(function(){
		location.href = 'main.php?page=files&fid='+$(this).attr('data-id')
	})
